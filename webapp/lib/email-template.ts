...
export function buildDiagnosticEmailHtml(data: EmailData): string {
  ...
  const flowBoxes = flowOrder.map((flow) => {
    ...
    const tag = isWeakest
      ...
      : isStrongest
      ? '<div style="font-size:10px;color:#1e40af;font-weight:bold;margin-top:2px;">Strongest</div>'
      : '';
    return `
  ...
  const actionItems = actions.map((action, i) => `
    <tr>
      <td style="vertical-align:top;padding:6px 8px 6px 0;width:28px;">
        <div style="width:22px;height:22px;background:#dbeafe;border-radius:50%;text-align:center;line-height:22px;font-size:11px;font-weight:bold;color:#1e3a8a;">${i + 1}</div>
      </td>
        ...
        <table width="100%" style="max-width:580px;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb;">
          ...
          <tr>
            <td style="background:#111827;padding:28px 32px 24px;">
              <div style="font-size:11px;font-weight:bold;color:#93c5fd;letter-spacing:1px;text-transform:uppercase;margin-bottom:6px;">Growth Engine Diagnostic</div>
          ...
          <tr>
            <td style="padding:28px 32px;">
              ...
              <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:10px;padding:18px 20px;margin-bottom:20px;">
                <div style="font-size:10px;font-weight:bold;color:#1e40af;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:6px;">Your Growth Profile</div>
              ...
              <div style="margin-bottom:24px;">
                <div style="font-size:14px;font-weight:bold;color:#111827;margin-bottom:4px;border-left:3px solid #1e40af;padding-left:10px;">Growth Trap Profile</div>
              ...
              <!-- Flow Scores -->
              <div style="margin-bottom:24px;">
                <div style="font-size:14px;font-weight:bold;color:#111827;margin-bottom:4px;border-left:3px solid #1e40af;padding-left:10px;">Flow Health Scores</div>
              ...
              <!-- Build First -->
              <div style="background:#f9fafb;border-left:4px solid #1e40af;border-radius:8px;padding:16px 18px;margin-bottom:20px;">
                <div style="font-size:10px;font-weight:bold;color:#1e40af;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:4px;">Build First</div>
              ...
              <div style="margin-bottom:24px;">
                <div style="font-size:14px;font-weight:bold;color:#111827;margin-bottom:4px;border-left:3px solid #1e40af;padding-left:10px;">Your First 3 Actions This Month</div>
              ...
              <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:10px;padding:24px;text-align:center;">
                ...
                <a href="${bookCallUrl}" style="display:inline-block;background:#1e40af;color:#ffffff;font-size:14px;font-weight:bold;padding:12px 28px;border-radius:8px;text-decoration:none;">
                  Book a Call
                </a>
              </div>
